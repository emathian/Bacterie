...
exclusion = ((p0$popB== 0 & p0$popA != 0) | (p0$popA==0 & p0$popB != 0))
cohabitation = (p0$popB != 0 & p0$popA != 0)

plot(p0$A[exclusion]~p0$Trenew[exclusion],pch=15,col='orange')
points(p0$A[extinction]~p0$Trenew[extinction],pch=15,col='red')
...
exclusion = ((p00001$popB== 0 & p00001$popA != 0) | (p00001$popA==0 & p00001$popB != 0))
cohabitation = (p00001$popB != 0 & p00001$popA != 0)

plot(p00001$A[exclusion]~p00001$Trenew[exclusion],pch=15,col='orange')
points(p00001$A[extinction]~p00001$Trenew[extinction],pch=15,col='red')
