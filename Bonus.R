...
p2 <- read.table("/Users/lisa/Documents/Cours/3-BiM/Projet_DevLog/Bacterie/csv/A_18_33_Dvarie.csv",sep=";",dec=".")
p3 <- read.table("/Users/lisa/Documents/Cours/3-BiM/Projet_DevLog/Bacterie/csv/pasmut34a50.csv",sep=";",dec=".")
...
exclusion0 = ((p0$popB== 0 & p0$popA != 0) | (p0$popA==0 & p0$popB != 0))
exclusion_elargie0 = ((p0$popB < 0.1*p0$popA & p0$popA != 0) | (p0$popA < 0.1*p0$popB & p0$popB != 0))
...
plot(p0$A[extinction0]~p0$Trenew[extinction0],
     ...
     main=c("Etat final de la population pour D =",D_poss[1]) ,
     xlab='T',ylab = 'A(init)')
